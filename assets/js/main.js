...
function convertPokemonToHtml(pokemon){
    ...
    return `<li class="pokemon ${pokemon.type} ">
                ...
                <div class="detail">
                 ...
                 <button id="more" type="button" data-id="${pokemon.id}" class="about ${pokemon.type}">
                    Sobre
                    </button>
                     <div class="stat-sheet">
                        <ol>
                        ${pokemon.name_stat.map(type => `<li class="type ${type}">${type}</li>`).join('')}
                        </ol>
                        <ol>
                        ${pokemon.base_stat.map(type => `<li class="type ${type}">${type}</li>`).join('')}
                        </ol>
                    </div>
            </li>`
}
